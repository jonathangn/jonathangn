...
I'm a **Full-Stack Developer** with 5+ years of experience building **enterprise applications**, **FinTech platforms**, and **scalable front-end architectures**.

My expertise focuses on **Angular, React, Next.js, Design Systems, and modern full-stack development**. Recently, I've expanded into **Data Science and Artificial Intelligence**, leveraging AI-driven workflows to accelerate product development and software delivery.

### Tech Stack

- Front-end: Angular, React, Next.js, Ionic
- Back-end: NestJS, Express, FastAPI, Spring Boot
- Data & AI: Python, TensorFlow, Scikit-learn, NLP
